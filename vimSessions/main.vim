...
set ruler
set runtimepath=~/.vim,~/.vim/pack/foo/start/vim-autoformat,~/.vim/pack/foo/start/rainbow,~/.vim/pack/foo/start/nerdtree,~/.vim/pack/foo/start/lightline.vim,~/.vim/pack/foo/start/emmet-vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vim81/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/after
...
silent! normal! zE
let s:l = 87 - ((38 * winheight(0) + 30) / 60)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 519 - ((33 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
519
...
tabnext 1
set stal=1
badd +0 main/html/index.html
badd +56 main/css/main.css
badd +1 main/js/main.js
badd +19 obitag/html/obitag.html
badd +4 obitag/css/obitag.css
badd +13 ./obitag/js/client/client.js
badd +68 ./obitag/js/server/classes.js
badd +1 references/multiplayerSnake/server/game.js
badd +17 obitag/js/client.js
badd +1 3
badd +2 references/multiplayerSnake/server/server.js
badd +1 obitag/js/classes.js
badd +1 ./obitag/js/server/objects.js
