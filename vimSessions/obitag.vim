...
silent! normal! zE
let s:l = 40 - ((38 * winheight(0) + 30) / 60)
...
normal! 0
tabnext
edit ./obitag/js/client/client.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((42 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
normal! 0
tabnext
edit ./obitag/js/server/classes.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((47 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
normal! 038|
tabnext
edit obitag/js/server/collision.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 5
set stal=1
badd +0 obitag/html/obitag.html
badd +1 obitag/css/obitag.css
badd +1 ./obitag/js/client/client.js
badd +1 ./obitag/js/server/classes.js
badd +1 references/multiplayerSnake/server/game.js
badd +17 obitag/js/client.js
badd +1 main/html/index.html
badd +1 3
badd +2 references/multiplayerSnake/server/server.js
badd +1 obitag/js/classes.js
badd +1 ./obitag/js/server/objects.js
badd +0 obitag/js/collision.js
badd +0 obitag/js/server/collision.js
